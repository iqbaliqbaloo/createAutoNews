...
SCENE_TEMPLATES = {
    ...
    "SPORTS_CRICKET": {
        "primary":    ["international cricket match national team stadium", "pakistan india cricket match action", "cricket national team players bat ball"],
        "secondary":  ["cricket fast bowler wicket celebration", "cricket batsman six boundary shot stadium", "cricket national team captain trophy"],
        "tertiary":   ["cricket fans national flag stadium crowd", "cricket world cup icc trophy ceremony", "cricket test match players white kit"],
        "quaternary": ["cricket umpire drs review decision", "cricket opening batsman crease national", "pakistan cricket players bat celebrate", "england australia ashes cricket match"],
        "quinary":    ["icc cricket championship national team", "cricket stadium floodlights night match", "cricket winning team celebration field", "cricket spin bowler delivery wicket"],
    },
    "FIFA": {
        "primary":    ["fifa world cup 2026 football stadium", "world cup match celebration crowd", "world cup goal players celebrate"],
        "secondary":  ["world cup group stage scoreboard", "world cup fans stadium flags", "football world cup trophy ceremony"],
        "tertiary":   ["world cup players national team jersey", "world cup stadium atmosphere crowd", "international football match action"],
        "quaternary": ["world cup goal celebration team", "world cup referee match decision", "world cup halftime score board", "world cup final whistle celebration"],
        "quinary":    ["football world cup 2026 usa canada mexico", "world cup team bench coaching staff", "world cup press conference interview", "world cup golden boot award"],
    },
    "SPORTS_FOOTBALL": {
...
BROAD_FALLBACKS = {
    ...
    "SPORTS_CRICKET":   ["international cricket match national team", "cricket stadium national players action", "cricket test odi t20i match"],
    "FIFA":             ["fifa world cup football stadium", "world cup match celebration", "world cup goal players"],
    "FIFA":             ["fifa world cup football celebration", "world cup stadium crowd", "world cup goal celebration"],
